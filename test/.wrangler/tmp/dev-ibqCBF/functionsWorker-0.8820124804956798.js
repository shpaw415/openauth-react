...
// .wrangler/tmp/pages-11wlKH/functionsWorker-0.8820124804956798.mjs
...
var invalid_key_input_default = /* @__PURE__ */ __name2((actual, ...types3) => {
...
async function generateChallenge(verifier, method) {
  ...
  const data = encoder22.encode(verifier);
...
function createSubjects(types22) {
  return { ...types22 };
}
...
var onRequest = /* @__PURE__ */ __name2((ctx) => new AuthManager({
  issuer: "http://localhost:8787",
...
var AuthManager2 = class {
  ...
  async callback({
    ...
    try {
      ...
      response.headers.set("Location", url.origin);
      setSession2(response, exchanged.tokens.access, exchanged.tokens.refresh);
      onSuccess(exchanged);
      return response;
    } catch (e) {
      await onError(e.cause);
  ...
  async verify(request) {
    ...
    const resp = await this.props.verify.onSuccess(verified);
    if (verified.tokens)
      setSession2(resp, verified.tokens.access, verified.tokens.refresh);
    return resp;
  }
};
function setSession2(response, access, refresh) {
  if (access) {
    response.headers.append("Set-Cookie", `access_token=${access}; HttpOnly; SameSite=Strict; Path=/; Max-Age=2147483647`);
  }
  if (refresh) {
...
__name(setSession2, "setSession2");
__name2(setSession2, "setSession");
var webcrypto_default2 = crypto;
var isCryptoKey2 = /* @__PURE__ */ __name2((key) => key instanceof CryptoKey, "isCryptoKey");
...
var encodeBase642 = /* @__PURE__ */ __name2((input) => {
  let unencoded = input;
  if (typeof unencoded === "string") {
...
var encode3 = /* @__PURE__ */ __name2((input) => {
  return encodeBase642(input).replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_");
}, "encode");
var decodeBase642 = /* @__PURE__ */ __name2((encoded) => {
  const binary = atob(encoded);
  const bytes = new Uint8Array(binary.length);
  for (let i = 0; i < binary.length; i++) {
    bytes[i] = binary.charCodeAt(i);
...
__export2(exports_errors2, {
  JWTInvalid: /* @__PURE__ */ __name2(() => JWTInvalid2, "JWTInvalid"),
  JWTExpired: /* @__PURE__ */ __name2(() => JWTExpired2, "JWTExpired"),
  JWTClaimValidationFailed: /* @__PURE__ */ __name2(() => JWTClaimValidationFailed2, "JWTClaimValidationFailed"),
  JWSSignatureVerificationFailed: /* @__PURE__ */ __name2(() => JWSSignatureVerificationFailed2, "JWSSignatureVerificationFailed"),
  JWSInvalid: /* @__PURE__ */ __name2(() => JWSInvalid2, "JWSInvalid"),
  JWKSTimeout: /* @__PURE__ */ __name2(() => JWKSTimeout2, "JWKSTimeout"),
  JWKSNoMatchingKey: /* @__PURE__ */ __name2(() => JWKSNoMatchingKey2, "JWKSNoMatchingKey"),
  JWKSMultipleMatchingKeys: /* @__PURE__ */ __name2(() => JWKSMultipleMatchingKeys2, "JWKSMultipleMatchingKeys"),
  JWKSInvalid: /* @__PURE__ */ __name2(() => JWKSInvalid2, "JWKSInvalid"),
  JWKInvalid: /* @__PURE__ */ __name2(() => JWKInvalid2, "JWKInvalid"),
  JWEInvalid: /* @__PURE__ */ __name2(() => JWEInvalid2, "JWEInvalid"),
  JWEDecryptionFailed: /* @__PURE__ */ __name2(() => JWEDecryptionFailed2, "JWEDecryptionFailed"),
  JOSENotSupported: /* @__PURE__ */ __name2(() => JOSENotSupported2, "JOSENotSupported"),
  JOSEError: /* @__PURE__ */ __name2(() => JOSEError2, "JOSEError"),
  JOSEAlgNotAllowed: /* @__PURE__ */ __name2(() => JOSEAlgNotAllowed2, "JOSEAlgNotAllowed")
});
var JOSEError2 = class extends Error {
  static {
    __name(this, "JOSEError2");
  }
  static {
    __name2(this, "JOSEError");
  }
...
var JWTClaimValidationFailed2 = class extends JOSEError2 {
  static {
    __name(this, "JWTClaimValidationFailed2");
  }
  static {
    __name2(this, "JWTClaimValidationFailed");
  }
...
var JOSEAlgNotAllowed2 = class extends JOSEError2 {
  static {
    __name(this, "JOSEAlgNotAllowed2");
  }
  static {
    __name2(this, "JOSEAlgNotAllowed");
  }
...
var JWEDecryptionFailed2 = class extends JOSEError2 {
  static {
    __name(this, "JWEDecryptionFailed2");
  }
  static {
    __name2(this, "JWEDecryptionFailed");
  }
...
var JWKSNoMatchingKey2 = class extends JOSEError2 {
  static {
    __name(this, "JWKSNoMatchingKey2");
  }
  static {
    __name2(this, "JWKSNoMatchingKey");
  }
...
var JWKSMultipleMatchingKeys2 = class extends JOSEError2 {
  static {
    __name(this, "JWKSMultipleMatchingKeys2");
  }
  static {
    __name2(this, "JWKSMultipleMatchingKeys");
  }
...
var JWSSignatureVerificationFailed2 = class extends JOSEError2 {
  static {
    __name(this, "JWSSignatureVerificationFailed2");
  }
  static {
    __name2(this, "JWSSignatureVerificationFailed");
  }
...
__name(unusable2, "unusable2");
__name2(unusable2, "unusable");
function isAlgorithm2(algorithm, name) {
  return algorithm.name === name;
}
__name(isAlgorithm2, "isAlgorithm2");
__name2(isAlgorithm2, "isAlgorithm");
function getHashLength2(hash) {
  return parseInt(hash.name.slice(4), 10);
}
__name(getHashLength2, "getHashLength2");
__name2(getHashLength2, "getHashLength");
...
__name(getNamedCurve2, "getNamedCurve2");
__name2(getNamedCurve2, "getNamedCurve");
...
__name(checkUsage2, "checkUsage2");
__name2(checkUsage2, "checkUsage");
...
__name(checkSigCryptoKey2, "checkSigCryptoKey2");
__name2(checkSigCryptoKey2, "checkSigCryptoKey");
...
__name(message2, "message2");
__name2(message2, "message");
var invalid_key_input_default2 = /* @__PURE__ */ __name2((actual, ...types3) => {
  return message2("Key must be ", actual, ...types3);
}, "invalid_key_input_default");
function withAlg2(alg, actual, ...types3) {
  return message2(`Key for the ${alg} algorithm must be `, actual, ...types3);
}
__name(withAlg2, "withAlg2");
__name2(withAlg2, "withAlg");
var is_key_like_default2 = /* @__PURE__ */ __name2((key) => {
  if (isCryptoKey2(key)) {
    return true;
  }
  return key?.[Symbol.toStringTag] === "KeyObject";
...
var isDisjoint2 = /* @__PURE__ */ __name2((...headers) => {
  const sources = headers.filter(Boolean);
  if (sources.length === 0 || sources.length === 1) {
    return true;
  }
...
var is_disjoint_default2 = isDisjoint2;
function isObjectLike2(value) {
  return typeof value === "object" && value !== null;
}
__name(isObjectLike2, "isObjectLike2");
__name2(isObjectLike2, "isObjectLike");
...
var check_key_length_default2 = /* @__PURE__ */ __name2((alg, key) => {
  if (alg.startsWith("RS") || alg.startsWith("PS")) {
    const { modulusLength } = key.algorithm;
    if (typeof modulusLength !== "number" || modulusLength < 2048) {
      throw new TypeError(`${alg} requires key modulusLength to be 2048 bits or larger`);
...
__name(isJWK2, "isJWK2");
__name2(isJWK2, "isJWK");
function isPrivateJWK2(key) {
  return key.kty !== "oct" && typeof key.d === "string";
}
__name(isPrivateJWK2, "isPrivateJWK2");
__name2(isPrivateJWK2, "isPrivateJWK");
function isPublicJWK2(key) {
  return key.kty !== "oct" && typeof key.d === "undefined";
}
__name(isPublicJWK2, "isPublicJWK2");
__name2(isPublicJWK2, "isPublicJWK");
function isSecretJWK2(key) {
  return isJWK2(key) && key.kty === "oct" && typeof key.k === "string";
}
__name(isSecretJWK2, "isSecretJWK2");
__name2(isSecretJWK2, "isSecretJWK");
...
__name(subtleMapping2, "subtleMapping2");
__name2(subtleMapping2, "subtleMapping");
var parse2 = /* @__PURE__ */ __name2(async (jwk) => {
  if (!jwk.alg) {
    throw new TypeError('"alg" argument is required when "jwk.alg" is not present');
  }
...
var exportKeyValue2 = /* @__PURE__ */ __name2((k) => decode3(k), "exportKeyValue");
var privCache2;
var pubCache2;
var isKeyObject2 = /* @__PURE__ */ __name2((key) => {
  return key?.[Symbol.toStringTag] === "KeyObject";
}, "isKeyObject");
var importAndCache2 = /* @__PURE__ */ __name2(async (cache, key, jwk, alg, freeze = false) => {
  let cached = cache.get(key);
  if (cached?.[alg]) {
    return cached[alg];
  }
...
var normalizePublicKey2 = /* @__PURE__ */ __name2((key, alg) => {
  if (isKeyObject2(key)) {
    let jwk = key.export({ format: "jwk" });
    delete jwk.d;
    delete jwk.dp;
    ...
    delete jwk.qi;
    if (jwk.k) {
      return exportKeyValue2(jwk.k);
    }
    pubCache2 || (pubCache2 = /* @__PURE__ */ new WeakMap());
    return importAndCache2(pubCache2, key, jwk, alg);
  }
  if (isJWK2(key)) {
    if (key.k)
      return decode3(key.k);
    pubCache2 || (pubCache2 = /* @__PURE__ */ new WeakMap());
    const cryptoKey = importAndCache2(pubCache2, key, key, alg, true);
    return cryptoKey;
  }
  return key;
}, "normalizePublicKey");
var normalizePrivateKey2 = /* @__PURE__ */ __name2((key, alg) => {
  if (isKeyObject2(key)) {
    let jwk = key.export({ format: "jwk" });
    if (jwk.k) {
      return exportKeyValue2(jwk.k);
    }
    privCache2 || (privCache2 = /* @__PURE__ */ new WeakMap());
    return importAndCache2(privCache2, key, jwk, alg);
  }
  if (isJWK2(key)) {
    if (key.k)
      return decode3(key.k);
    privCache2 || (privCache2 = /* @__PURE__ */ new WeakMap());
    const cryptoKey = importAndCache2(privCache2, key, key, alg, true);
    return cryptoKey;
  }
  return key;
}, "normalizePrivateKey");
var normalize_key_default2 = { normalizePublicKey: normalizePublicKey2, normalizePrivateKey: normalizePrivateKey2 };
...
__name(importJWK2, "importJWK2");
__name2(importJWK2, "importJWK");
var tag2 = /* @__PURE__ */ __name2((key) => key?.[Symbol.toStringTag], "tag");
var jwkMatchesOp2 = /* @__PURE__ */ __name2((alg, key, usage) => {
  if (key.use !== void 0 && key.use !== "sig") {
    throw new TypeError("Invalid key for this operation, when present its use must be sig");
  }
  if (key.key_ops !== void 0 && key.key_ops.includes?.(usage) !== true) {
...
var symmetricTypeCheck2 = /* @__PURE__ */ __name2((alg, key, usage, allowJwk) => {
  if (key instanceof Uint8Array)
    return;
  if (allowJwk && isJWK2(key)) {
    if (isSecretJWK2(key) && jwkMatchesOp2(alg, key, usage))
      return;
    throw new TypeError(`JSON Web Key for symmetric algorithms must have JWK "kty" (Key Type) equal to "oct" and the JWK "k" (Key Value) present`);
  }
  if (!is_key_like_default2(key)) {
    throw new TypeError(withAlg2(alg, key, ...types2, "Uint8Array", allowJwk ? "JSON Web Key" : null));
  }
  if (key.type !== "secret") {
    throw new TypeError(`${tag2(key)} instances for symmetric algorithms must be of type "secret"`);
  }
}, "symmetricTypeCheck");
var asymmetricTypeCheck2 = /* @__PURE__ */ __name2((alg, key, usage, allowJwk) => {
  if (allowJwk && isJWK2(key)) {
    switch (usage) {
      case "sign":
  ...
  if (!is_key_like_default2(key)) {
    throw new TypeError(withAlg2(alg, key, ...types2, allowJwk ? "JSON Web Key" : null));
  }
  if (key.type === "secret") {
...
function checkKeyType2(allowJwk, alg, key, usage) {
  const symmetric = alg.startsWith("HS") || alg === "dir" || alg.startsWith("PBES2") || /^A\d{3}(?:GCM)?KW$/.test(alg);
  if (symmetric) {
    symmetricTypeCheck2(alg, key, usage, allowJwk);
  } else {
    asymmetricTypeCheck2(alg, key, usage, allowJwk);
  }
}
__name(checkKeyType2, "checkKeyType2");
__name2(checkKeyType2, "checkKeyType");
var check_key_type_default2 = checkKeyType2.bind(void 0, false);
var checkKeyTypeWithJwk2 = checkKeyType2.bind(void 0, true);
...
__name(validateCrit2, "validateCrit2");
__name2(validateCrit2, "validateCrit");
var validate_crit_default2 = validateCrit2;
var validateAlgorithms2 = /* @__PURE__ */ __name2((option, algorithms) => {
  if (algorithms !== void 0 && (!Array.isArray(algorithms) || algorithms.some((s) => typeof s !== "string"))) {
    throw new TypeError(`"${option}" option must be an array of strings`);
  }
  if (!algorithms) {
...
var validate_algorithms_default2 = validateAlgorithms2;
...
__name(subtleDsa2, "subtleDsa2");
__name2(subtleDsa2, "subtleDsa");
async function getCryptoKey2(alg, key, usage) {
  if (usage === "sign") {
    key = await normalize_key_default2.normalizePrivateKey(key, alg);
  }
  if (usage === "verify") {
    key = await normalize_key_default2.normalizePublicKey(key, alg);
  }
  if (isCryptoKey2(key)) {
  ...
  throw new TypeError(invalid_key_input_default2(key, ...types2, "Uint8Array", "JSON Web Key"));
}
__name(getCryptoKey2, "getCryptoKey2");
__name2(getCryptoKey2, "getCryptoKey");
var verify2 = /* @__PURE__ */ __name2(async (alg, key, signature, data) => {
...
async function flattenedVerify2(jws, key, options) {
  ...
  const extensions = validate_crit_default2(JWSInvalid2, /* @__PURE__ */ new Map([["b64", true]]), options?.crit, parsedProt, joseHeader);
  let b64 = true;
  if (extensions.has("b64")) {
    b64 = parsedProt.b64;
    if (typeof b64 !== "boolean") {
  ...
  if (typeof key === "function") {
    key = await key(parsedProt, jws);
    resolvedKey = true;
    checkKeyTypeWithJwk2(alg, key, "verify");
    if (isJWK2(key)) {
  ...
  const verified = await verify_default2(alg, key, signature, data);
  if (!verified) {
...
__name(flattenedVerify2, "flattenedVerify2");
__name2(flattenedVerify2, "flattenedVerify");
...
__name(compactVerify2, "compactVerify2");
__name2(compactVerify2, "compactVerify");
var epoch_default2 = /* @__PURE__ */ __name2((date) => Math.floor(date.getTime() / 1e3), "epoch_default");
var minute2 = 60;
...
var secs_default2 = /* @__PURE__ */ __name2((str) => {
...
var normalizeTyp2 = /* @__PURE__ */ __name2((value) => value.toLowerCase().replace(/^application\//, ""), "normalizeTyp");
var checkAudiencePresence2 = /* @__PURE__ */ __name2((audPayload, audOption) => {
  if (typeof audPayload === "string") {
    return audOption.includes(audPayload);
  }
  if (Array.isArray(audPayload)) {
...
var jwt_claims_set_default2 = /* @__PURE__ */ __name2((protectedHeader, encodedPayload, options = {}) => {
  let payload;
  try {
  ...
  const { currentDate } = options;
  const now = epoch_default2(currentDate || /* @__PURE__ */ new Date());
  if ((payload.iat !== void 0 || maxTokenAge) && typeof payload.iat !== "number") {
  ...
  if (maxTokenAge) {
    const age = now - payload.iat;
    const max = typeof maxTokenAge === "number" ? maxTokenAge : secs_default2(maxTokenAge);
    if (age - tolerance > max) {
...
async function jwtVerify2(jwt, key, options) {
  ...
  const payload = jwt_claims_set_default2(verified.protectedHeader, verified.payload, options);
  const result = { payload, protectedHeader: verified.protectedHeader };
  if (typeof key === "function") {
    return { ...result, key: verified.key };
  }
...
__name(jwtVerify2, "jwtVerify2");
__name2(jwtVerify2, "jwtVerify");
...
__name(getKtyFromAlg2, "getKtyFromAlg2");
__name2(getKtyFromAlg2, "getKtyFromAlg");
function isJWKSLike2(jwks) {
  return jwks && typeof jwks === "object" && Array.isArray(jwks.keys) && jwks.keys.every(isJWKLike2);
}
__name(isJWKSLike2, "isJWKSLike2");
__name2(isJWKSLike2, "isJWKSLike");
function isJWKLike2(key) {
  return isObject2(key);
}
__name(isJWKLike2, "isJWKLike2");
__name2(isJWKLike2, "isJWKLike");
function clone2(obj) {
  if (typeof structuredClone === "function") {
    return structuredClone(obj);
  }
...
var LocalJWKSet2 = class {
  ...
  async getKey(protectedHeader, token) {
    ...
    return importWithAlgCache2(this._cached, jwk, alg);
  }
};
async function importWithAlgCache2(cache, jwk, alg) {
  const cached = cache.get(jwk) || cache.set(jwk, {}).get(jwk);
  if (cached[alg] === void 0) {
...
__name(importWithAlgCache2, "importWithAlgCache2");
__name2(importWithAlgCache2, "importWithAlgCache");
function createLocalJWKSet2(jwks) {
  const set = new LocalJWKSet2(jwks);
  const localJWKSet = /* @__PURE__ */ __name2(async (protectedHeader, token) => set.getKey(protectedHeader, token), "localJWKSet");
  Object.defineProperties(localJWKSet, {
    jwks: {
      value: /* @__PURE__ */ __name2(() => clone2(set._jwks), "value"),
      enumerable: true,
      configurable: false,
      writable: false
    }
...
__name(createLocalJWKSet2, "createLocalJWKSet2");
__name2(createLocalJWKSet2, "createLocalJWKSet");
var exports_base64url2 = {};
__export2(exports_base64url2, {
  encode: /* @__PURE__ */ __name2(() => encode22, "encode"),
  decode: /* @__PURE__ */ __name2(() => decode22, "decode")
});
var encode22 = encode3;
var decode22 = decode3;
function decodeJwt2(jwt) {
  if (typeof jwt !== "string")
    throw new JWTInvalid2("JWTs must use Compact JWS serialization, JWT must be a string");
  const { 1: payload, length } = jwt.split(".");
  if (length === 5)
    throw new JWTInvalid2("Only JWTs using Compact JWS serialization can be decoded");
  if (length !== 3)
    throw new JWTInvalid2("Invalid JWT");
  if (!payload)
    throw new JWTInvalid2("JWTs must contain a payload");
  let decoded;
  try {
    decoded = decode22(payload);
  } catch {
    throw new JWTInvalid2("Failed to base64url decode the payload");
  }
  let result;
  try {
    result = JSON.parse(decoder2.decode(decoded));
  } catch {
    throw new JWTInvalid2("Failed to parse the decoded payload as JSON");
  }
  if (!isObject2(result))
    throw new JWTInvalid2("Invalid JWT Claims Set");
  return result;
}
__name(decodeJwt2, "decodeJwt2");
__name2(decodeJwt2, "decodeJwt");
var InvalidSubjectError2 = class extends Error {
  static {
    __name(this, "InvalidSubjectError2");
  }
  static {
    __name2(this, "InvalidSubjectError");
  }
...
var InvalidRefreshTokenError2 = class extends Error {
  static {
    __name(this, "InvalidRefreshTokenError2");
  }
  static {
    __name2(this, "InvalidRefreshTokenError");
  }
...
var InvalidAccessTokenError2 = class extends Error {
  static {
    __name(this, "InvalidAccessTokenError2");
  }
  static {
    __name2(this, "InvalidAccessTokenError");
  }
...
var InvalidAuthorizationCodeError2 = class extends Error {
  static {
    __name(this, "InvalidAuthorizationCodeError2");
  }
  static {
    __name2(this, "InvalidAuthorizationCodeError");
  }
...
function generateVerifier2(length) {
  const buffer = new Uint8Array(length);
  crypto.getRandomValues(buffer);
  return exports_base64url2.encode(buffer);
}
__name(generateVerifier2, "generateVerifier2");
__name2(generateVerifier2, "generateVerifier");
async function generateChallenge2(verifier, method) {
  if (method === "plain")
    return verifier;
  const encoder22 = new TextEncoder();
  const data = encoder22.encode(verifier);
  const hash = await crypto.subtle.digest("SHA-256", data);
  return exports_base64url2.encode(new Uint8Array(hash));
}
__name(generateChallenge2, "generateChallenge2");
__name2(generateChallenge2, "generateChallenge");
async function generatePKCE2(length = 64) {
  if (length < 43 || length > 128) {
    throw new Error("Code verifier length must be between 43 and 128 characters");
  }
  const verifier = generateVerifier2(length);
  const challenge = await generateChallenge2(verifier, "S256");
  return {
    verifier,
    challenge,
    method: "S256"
...
__name(generatePKCE2, "generatePKCE2");
__name2(generatePKCE2, "generatePKCE");
function createClient2(input) {
  ...
  async function getJWKS() {
    ...
    if (cached)
      return cached;
    const keyset = await (f || fetch)(wk.jwks_uri).then((r) => r.json());
    const result2 = createLocalJWKSet2(keyset);
    jwksCache.set(issuer, result2);
    return result2;
  }
  __name(getJWKS, "getJWKS");
  ...
  const result = {
    async authorize(redirectURI, response, opts) {
      ...
      if (opts?.provider)
        result2.searchParams.set("provider", opts.provider);
      if (opts?.pkce && response === "code") {
        const pkce = await generatePKCE2();
        result2.searchParams.set("code_challenge_method", "S256");
        result2.searchParams.set("code_challenge", pkce.challenge);
        challenge.verifier = pkce.verifier;
      }
    ...
    async exchange(code, redirectURI, verifier) {
      ...
      if (!tokens.ok) {
        return {
          err: new InvalidAuthorizationCodeError2()
        };
      }
      return {
        err: false,
    ...
    async refresh(refresh, opts) {
      if (opts && opts.access) {
        const decoded = decodeJwt2(opts.access);
        if (!decoded) {
          return {
            err: new InvalidAccessTokenError2()
          };
        }
        if ((decoded.exp || 0) > Date.now() / 1e3 + 30) {
          return {
      ...
      if (!tokens.ok) {
        return {
          err: new InvalidRefreshTokenError2()
        };
      }
      return {
        err: false,
    ...
    async verify(subjects3, token, options) {
      const jwks = await getJWKS();
      try {
        const result2 = await jwtVerify2(token, jwks, {
          issuer
        });
        const validated = await subjects3[result2.payload.type]["~standard"].validate(result2.payload.properties);
        if (!validated.issues && result2.payload.mode === "access")
        ...
        return {
          err: new InvalidSubjectError2()
        };
      } catch (e) {
        if (e instanceof exports_errors2.JWTExpired && options?.refresh) {
          const refreshed = await this.refresh(options.refresh);
          if (refreshed.err)
            return refreshed;
          const verified = await result.verify(subjects3, refreshed.tokens.access, {
...
function createSubjects2(types22) {
  return { ...types22 };
}
__name(createSubjects2, "createSubjects2");
__name2(createSubjects2, "createSubjects");
var store$42;
...
__name(getGlobalConfig2, "getGlobalConfig2");
__name2(getGlobalConfig2, "getGlobalConfig");
var store$32;
function getGlobalMessage2(lang) {
  return store$32?.get(lang);
}
__name(getGlobalMessage2, "getGlobalMessage2");
__name2(getGlobalMessage2, "getGlobalMessage");
var store$22;
function getSchemaMessage2(lang) {
  return store$22?.get(lang);
}
__name(getSchemaMessage2, "getSchemaMessage2");
__name2(getSchemaMessage2, "getSchemaMessage");
var store$12;
function getSpecificMessage2(reference, lang) {
  return store$12?.get(reference)?.get(lang);
}
__name(getSpecificMessage2, "getSpecificMessage2");
__name2(getSpecificMessage2, "getSpecificMessage");
...
__name(_stringify2, "_stringify2");
__name2(_stringify2, "_stringify");
...
__name(_addIssue2, "_addIssue2");
__name2(_addIssue2, "_addIssue");
...
__name(_getStandardProps2, "_getStandardProps2");
__name2(_getStandardProps2, "_getStandardProps");
function getFallback2(schema, dataset, config$1) {
  return typeof schema.fallback === "function" ? schema.fallback(dataset, config$1) : schema.fallback;
}
__name(getFallback2, "getFallback2");
__name2(getFallback2, "getFallback");
function getDefault2(schema, dataset, config$1) {
  return typeof schema.default === "function" ? schema.default(dataset, config$1) : schema.default;
}
__name(getDefault2, "getDefault2");
__name2(getDefault2, "getDefault");
...
var subjects2 = createSubjects2({
  user: object2({
    id: string2()
  })
});
var onRequest2 = /* @__PURE__ */ __name2((ctx) => new AuthManager2({
  issuer: "http://localhost:8787",
  redirectURI: "http://localhost:3001/frontend-auth/callback",
  client: client2,
  publicPath: "/auth",
...
// .wrangler/tmp/bundle-fvkxJk/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-fvkxJk/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8820124804956798.js.map
